...
async def test_repo(db_session: AsyncSession) -> BaseRepository[TestModel]:
    """Create a test repository instance."""
    return BaseRepository(TestModel, db_session)


@pytest.mark.asyncio
async def test_create(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_get_existing(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_get_nonexistent(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_get_or_404_existing(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_get_or_404_nonexistent(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_update(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_update_partial(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_update_nonexistent(test_repo: BaseRepository[TestModel]) -> None:
...
async def test_update_ignores_invalid_fields(
    test_repo: BaseRepository[TestModel],
) -> None:
...
@pytest.mark.asyncio
async def test_delete(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_delete_nonexistent(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_count_empty(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_count_with_entities(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_exists_true(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_exists_false(test_repo: BaseRepository[TestModel]) -> None:
...
@pytest.mark.asyncio
async def test_multiple_operations(test_repo: BaseRepository[TestModel]) -> None:
